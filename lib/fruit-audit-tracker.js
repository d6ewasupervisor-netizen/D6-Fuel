...
const DEFAULT_D1_ASSIGNMENTS = [
  { storeId: '035', name: 'Julie Ferguson', email: 'julie.ferguson@retailodyssey.com' },
  { storeId: '040', name: 'Julie Ferguson', email: 'julie.ferguson@retailodyssey.com' },
  { storeId: '060', name: 'Cindi Griggs', email: 'cindi.griggs@retailodyssey.com' },
  { storeId: '063', name: 'Angelina Iniguez Carrillo', email: 'kalleen.iniguezcarri@retailodyssey.com' },
  { storeId: '143', name: 'Cindi Griggs', email: 'cindi.griggs@retailodyssey.com' },
  { storeId: '153', name: 'Angelina Iniguez Carrillo', email: 'kalleen.iniguezcarri@retailodyssey.com' },
  { storeId: '218', name: 'Jennifer Russell', email: 'jennifer.russell@sasretailservices.com' },
  { storeId: '240', name: 'Angelina Iniguez Carrillo', email: 'kalleen.iniguezcarri@retailodyssey.com' },
  { storeId: '242', name: 'Michelle Sweet', email: 'michelle.sweet@youradv.com' },
  { storeId: '285', name: 'Julie Ferguson', email: 'julie.ferguson@retailodyssey.com' },
  { storeId: '375', name: 'Victor Trevino Gonzalez', email: 'victor.trevino@retailodyssey.com' },
  { storeId: '377', name: 'Kimberlee SanchezCanastuj', email: 'kim.sanchezcanastuj@retailodyssey.com' },
  { storeId: '393', name: 'Victor Trevino Gonzalez', email: 'victor.trevino@retailodyssey.com' },
  { storeId: '462', name: 'Tamera Sandeno', email: 'tamera.sandeno@retailodyssey.com' },
  { storeId: '482', name: 'Julie Ferguson', email: 'julie.ferguson@retailodyssey.com' },
  { storeId: '516', name: 'Victor Trevino Gonzalez', email: 'victor.trevino@retailodyssey.com' },
  { storeId: '651', name: 'Michelle Sweet', email: 'michelle.sweet@youradv.com' },
  { storeId: '661', name: 'Omar Robles', email: 'omar.robles@retailodyssey.com' },
  { storeId: '694', name: 'Angelina Iniguez Carrillo', email: 'kalleen.iniguezcarri@retailodyssey.com' },
];
...
function syncDefaultAssignments({ persistChanges = false } = {}) {
  ...
  for (const assignment of DEFAULT_D1_ASSIGNMENTS) {
    ...
    if (activePledgeForStore(pledge.storeId)) continue;
    if (optedOutEmails.has(normalizeEmail(pledge.email))) continue;
